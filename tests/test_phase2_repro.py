...
"""
    ...
    try:
        ...
        with patch('chirality.application.phase2.tensor_engine.resolve_tensor_cell') as mock_resolve:
    ...
    try:
        ...
        with patch('chirality.application.phase2.tensor_engine.resolve_tensor_cell') as mock_resolve:
            ...
            def mock_resolver(*args, **kwargs):
                ...
                return {
                    "value": f"result_for_{input_hash}",
...
def test_phase2_resume_capability(temp_artifacts_dir):
    ...
    try:
        ...
        with patch('chirality.application.phase2.tensor_engine.resolve_tensor_cell') as mock_resolve:
            ...
            run_phase2(str(tensor_spec), str(snapshot_file), output_dir=str(output_dir), resume=True)
