...
replacements = [
    ...
    ('from chirality.application.services.pipeline_service', 'from chirality.application.services.pipeline_service'),
    ...
    ('from chirality.infrastructure.llm.mock_resolvers', 'from chirality.infrastructure.llm.mock_resolvers'),
    ('from chirality.infrastructure.monitoring.tracer', 'from chirality.infrastructure.monitoring.tracer'),
    ('from chirality.infrastructure.api.guards', 'from chirality.infrastructure.api.guards'),
    ('from chirality.infrastructure.llm.openai_adapter', 'from chirality.infrastructure.llm.openai_adapter'),
    ('import chirality.domain.types', 'import chirality.domain.types'),
    ('import chirality.application.services.pipeline_service', 'import chirality.application.services.pipeline_service'),
