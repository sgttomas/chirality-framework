...
class BudgetTracker:
    ...
    def _check_budgets(self):
        ...
        # Token budget
        if (self.config.token_budget and 
        ...
        # Cost budget
        if (self.config.cost_budget and 
            self.cost_spent > self.config.cost_budget):
            raise RuntimeError(
    ...
    def get_status(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "tokens": {
                ...
                "utilization": (
                    self.token_count / self.config.token_budget 
                    if self.config.token_budget else None
                )
            },
            "cost": {
                ...
                "utilization": (
                    self.cost_spent / self.config.cost_budget 
                    if self.config.cost_budget else None
                )
            },
            "time": {
                "elapsed": elapsed,
                ...
                "utilization": (
                    elapsed / self.config.time_budget 
